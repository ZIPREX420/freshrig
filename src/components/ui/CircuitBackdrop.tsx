...
export function CircuitBackdrop({
  ...
  // Deterministic pseudo-random so renders stay stable across re-mounts (no
  // motion when nothing changes — important for a backdrop you don't want
  // to draw the eye every render).
  ...
  // Pick stroke colour based on x-position when accent === "dual".
